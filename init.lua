...
hs.hotkey.bind({"`", "cmd"}, "f", function() hs.application.launchOrFocus("Finder"); c() end)
hs.hotkey.bind({"`", "cmd"}, "l", function() hs.application.launchOrFocus("iTerm2"); c() end)
hs.hotkey.bind({"`", "cmd"}, ";", function() hs.application.launchOrFocus("Visual Studio Code"); c() end)
hs.hotkey.bind({"`", "cmd"}, "b", function() hs.application.launchOrFocus("Brave Browswer"); c() end)
